...
void exposeProblemMission() {
  ...
  bp::class_<ProblemMission>(
      "ProblemMission",
      bp::init<boost::shared_ptr<Mission>, boost::shared_ptr<MultiCopterBaseParams>,
               boost::shared_ptr<pinocchio::Model>, boost::shared_ptr<crocoddyl::ActuationModelAbstract>, int, double>(
          bp::args("mission", "mc_params", "mc_model",
                   "actuation"
                   "frame_id",
                   "dt"),
          "Initialize mission problem"))
