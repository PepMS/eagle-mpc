#ifndef BINDINGS_PYTHON_MULTICOPTER_MPC_UTILS_ACTUATION_HPP_
#define BINDINGS_PYTHON_MULTICOPTER_MPC_UTILS_ACTUATION_HPP_
...
#endif  // BINDINGS_PYTHON_OPTIUAVM_UTILS_ACTUATION_HPP_
