#ifndef BINDINGS_PYTHON_MULTICOPTER_MPC_OCP_TRAJECTORY_GENERATOR_HPP_
#define BINDINGS_PYTHON_MULTICOPTER_MPC_OCP_TRAJECTORY_GENERATOR_HPP_
...
void solve_no_args(OcpAbstract& ocp){return ocp.solve();}
