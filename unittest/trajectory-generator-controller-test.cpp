...
BOOST_AUTO_TEST_CASE(constructor_test, *boost::unit_test::tolerance(1e-7)) {
  ...
  BOOST_CHECK(tgc_test.tg_controller_->getTrajectoryGenerator() != nullptr);
  BOOST_CHECK(tgc_test.tg_controller_->getTrajectoryGenerator()->getMission() == tgc_test.mc_mission_);
}
...
BOOST_AUTO_TEST_CASE(initialize_tg_test, *boost::unit_test::tolerance(1e-7)) {
  TGControllerTest tgc_test("takeoff.yaml");

  tgc_test.tg_controller_->initializeTrajectoryGen(multicopter_mpc::SolverTypes::BoxFDDP);

  BOOST_CHECK(tgc_test.tg_controller_->getTrajectoryGenerator()->getProblem() != nullptr);
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[0].knots == 100);  // state trajectory 99
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[1].knots == 101);  // state trajectory 200
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[2].knots == 75);   // state trajectory 274
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[3].knots == 76);   // state trajectory 350
  // Check references
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[0].pose.translation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(99).head(3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[1].pose.translation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[0].pose.translation());
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[2].pose.translation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(274).head(3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[3].pose.translation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[1].pose.translation());

  Eigen::Quaterniond quat(
      static_cast<Eigen::Vector4d>(tgc_test.tg_controller_->getTrajectoryGenerator()->getState(99).segment(3, 4)));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[0].pose.rotation() == quat.toRotationMatrix());
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[1].pose.rotation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[0].pose.rotation());
  quat = Eigen::Quaterniond(
      static_cast<Eigen::Vector4d>(tgc_test.tg_controller_->getTrajectoryGenerator()->getState(274).segment(3, 4)));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[2].pose.rotation() == quat.toRotationMatrix());
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[3].pose.rotation() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[1].pose.rotation());

  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[0].vel->linear() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(99).segment(7, 3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[1].vel->linear() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[0].vel->linear());
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[2].vel->linear() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(274).segment(7, 3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[3].vel->linear() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[1].vel->linear());

  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[0].vel->angular() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(99).segment(10, 3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[1].vel->angular() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[0].vel->angular());
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[2].vel->angular() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getState(274).segment(10, 3));
  BOOST_CHECK(tgc_test.tg_controller_->getMission()->getWaypoints()[3].vel->angular() ==
              tgc_test.tg_controller_->getTrajectoryGenerator()->getMission()->getWaypoints()[1].vel->angular());
}
...
BOOST_AUTO_TEST_CASE(update_terminal_cost_test, *boost::unit_test::tolerance(1e-7)) {
  ...
  BOOST_CHECK(tgc_test.tg_controller_->getHasMotionRef() == true);
}
