...
yaml_mission = yaml_parser.ParserYAML(
    "/home/pepms/robotics/libraries/multicopter_mpc/config/mission/simple.yaml", "", True)
...
actuation = crocoddyl.ActuationModelMultiCopterBase(state, mc_params.n_rotors,
                                                    mc_params.tau_f)
problem_mission = multicopter_mpc.ProblemMission(
    mission, mc_params, uav_model, actuation, uav_model.getFrameId(link_name),
    dt)
