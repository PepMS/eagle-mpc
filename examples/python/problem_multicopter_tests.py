...
problem.runningDatas[0].differential.costs.costs.update({'sBarrier', problem.runningModels[0].differential.costs.costs['sBarrier'].cost.createData(problem.runningDatas[0].differential.costs.shared)})
